...
//        header('Content-Type: application/json;charset=UTR-8');
        ...
        if ($user_info == false) {
            echo json_encode(array('valid_username' => false, 'valid_password' => false, 'authenic_user' => false));
            return;
        }
        ...
        if ($user_info->password == $password) {
            ...
            echo json_encode(array('valid_username' => true, 'valid_password' => true, 'authenic_user' => true));
